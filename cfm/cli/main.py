""" Loads all commands for cfm command line interface
...
@click_plugins.with_plugins(ep for ep in
                            iter_entry_points('cfm.cfm_commands'))
@click.group(help='cfm command line interface', context_settings=_context)
